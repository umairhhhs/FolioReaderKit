...
class FolioReaderChapterList: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if
            ...
            cell.indexLabel?.textColor = (tocReference.resource == resource ? self.readerConfig.tintColor(isNightMode: folioReader.nightMode) : self.readerConfig.menuTextColor)
        }
